...
app.layout = html.Div([
    ...
    html.Div(
        ...
        children=[
            ...
            html.P("Esta aplicación muestra una gráfica de línea con datos de humedad y temperatura. Los datos fueron generados con un código de python que genero 100 datos entre 0 y 100 tanto para temperatura como para humedad."),
